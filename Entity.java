...
public abstract class Entity {
    ...
    //------helper function to check if position is not occupied)---------------
    public int getBottomEdge (){  //Entity entity){
        return getY() + getHeight(); //entity.getY() + entity.getHeight();
    }

    public int getRightEdge (){ //Entity entity){
    ...
    public boolean isCollidingWith(Entity other){
        ...
        if (this.getX() > other.getRightEdge() || this.getRightEdge() < other.getX()){
            return false;
        }
        else if (this.getY() > other.getBottomEdge() || this.getBottomEdge() < other.getY()){
            return false;
        } 
        return true; 
    }
